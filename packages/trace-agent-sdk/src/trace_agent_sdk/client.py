...
class RunSession:
    def __init__(self, client: "TraceAgentClient", run_id: str, agent_name: str, goal: str, metadata: dict[str, Any] | None = None) -> None:
        self.client = client
        self.run_id = run_id
    ...
    def as_langchain_callback(
        ...
        *,
        ...
        return TraceAgentLangChainCallback(
            self,
